...
<Tippy interactive={true} interactiveBorder={2} duration={4} content={
    ...
    <a href="https://martechrecord.com/our-events" className="mx-1 sm:mx-6   transition duration-300 hover:text-gray-400 text-white text-xs lg:text-base font-medium uppercase">
     ...
     <a href="https://martechrecord.com/about" className="mx-1 sm:mx-6   transition duration-300 hover:text-gray-400 text-white text-xs lg:text-base font-medium uppercase">
            about
            </a>
      <a href="https://martechrecord.com/sign-up" className="mx-1 sm:mx-6   transition duration-300 hover:text-gray-400 text-white text-xs lg:text-base font-medium uppercase">
            sign up
            </a>
          <div className="flex justify-center items-center justify-self-end">
          <IconContext.Provider value={{color: 'white', className: "h-4 mx-1 sm:mx-5"}}>
<a href="https://twitter.com/martechrecord">          <FaTwitter/></a>
        </IconContext.Provider>
          <IconContext.Provider value={{color: 'white', className: "h-4 ml-1 sm:ml-5"}}>
<a href="https://www.linkedin.com/company/martech-record/">          <GrLinkedinOption /></a>
        </IconContext.Provider>
        </div>
        </div>
      </div>
